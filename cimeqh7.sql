...
CREATE TABLE `tblcostos` (
  ...
  KEY `fac` (`facturaId`),
  CONSTRAINT `546` FOREIGN KEY (`facturaId`) REFERENCES `tblfacturas` (`idFacturas`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tblfacturas` VALUES (1,1,'0801-1995',1,'2017-07-26 13:23:55',75.19999694824219,'2017-07-26 13:23:55',NULL),(2,5,'0801-1995',5,'2017-07-26 13:23:55',89.5,'2017-07-26 13:23:55',NULL),(3,6231,'0801-1995',6,'2017-07-26 13:23:55',95.69999694824219,NULL,NULL),(4,531,'123',2,'2017-07-26 13:23:55',100.5,NULL,NULL);
...
-- Dump completed on 2017-08-08 11:32:07
