                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              {{if pospuesto}}
                                <a href="index.php?page=pagos"><button type="button" class="btn btn-success">Aceptar Fecha y Pagar despeje de Energia</button></a>
                              {{endif pospuesto}}
                              {{if reintentar}}
                              ...
                              {{endif reintentar}}
                              {{ifnot reintentar}}
                                <a href="index.php?page=pagos"><button type="button" class="btn btn-primary">Pagar despeje de Energia</button></a>
                              {{endifnot reintentar}}
