    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">E-CIMEQH</a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>CIMEQH</h2>
                            <hr class="star-primary">
                            <p>Mediante esta plataforma web, estaras en directa comunicacion con el colegio de ingenieros sin moverte de tu casa u oficina!</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>ENEE</h2>
                            <hr class="star-primary">
                            <p>Mediante esta plataforma web, estaras en directa comunicacion con la empresa nacional de energia electroca sin moverte de tu casa u oficina!</p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
                        </div>
                    </div>
                </div>
