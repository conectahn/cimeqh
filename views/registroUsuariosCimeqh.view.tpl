                  ...
                  <br>
                    ...
                    <form id="defaultForm"  class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label for="form_name">Cargo/Rol *</label>
...
<div class="form-group">
  <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
    <button name="btnRegistroUsuariosCimeqh" id="btnRegistroUsuariosCimeqh" type="submit" class="btn btn-primary btn-lg">Registrar</button>
  </div>
</div>
